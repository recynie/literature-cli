...
class AuthorService:
    ...
    def _assign_simple_fields(self, author: Author, data: dict[str, Any], partial: bool = False) -> None:
        fields = ("full_name", "first_name", "last_name", "email", "personal_url", "faculty_url", "scholar_url", "orcid", "openalex_id", "semantic_scholar_id", "dblp_pid")
        for field in fields:
            if field in data:
    ...
    def _fill_missing_fields(self, target: Author, source: Author) -> None:
        for field in ("first_name", "last_name", "email", "personal_url", "faculty_url", "scholar_url", "orcid", "openalex_id", "semantic_scholar_id", "dblp_pid", "affiliation_id"):
